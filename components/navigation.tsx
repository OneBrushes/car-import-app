...
import { Car, MapPin, Scale, Archive, Home, Menu, X, FileText, TrendingUp, Wrench } from "lucide-react"
...
export function Navigation({ activeTab, onTabChange, role }: NavigationProps) {
  ...
  const allTabs = [
    ...
    { id: "checklist", label: "Checklist", icon: Wrench, roles: ['importador', 'admin'] },
  ]
